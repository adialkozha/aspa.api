...
namespace AspaApp.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(ApplicationContext context)
        {
            ...
            {
                Сategory food = new Сategory { СategoryName = "Еда" };
                Сategory householdgoods = new Сategory { СategoryName = "Хозяйственные товары" };
                db.Categories.AddRange(food, householdgoods);
                db.SaveChanges();
            }
        ...
        {
            Product product = new Product { ProductName = pvm.ProductName, ProductCost = pvm.ProductCost, СategoryId = pvm.СategoryId };
